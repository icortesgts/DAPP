<%@ Page Title="Edición Clase Documento" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditarCamposAdicionales.aspx.vb" Inherits="DAPP.EditarCamposAdicionales" %>
    ...
    <div class="container mrgnBotMd">
        <div class="row noPadding">
            <div class="col-sm-12 noPadding colHeight">
                <h3>CAMPOS ADICONALES POR TIPO DE DOCUMENTO</h3>               
                    <div class="form-horizontal fom-border">                        
                                <br />
                                <br />                                
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="LblTipo" runat="server" Text="Tipo de Documento: " Width="400px" />
                                    </b>
                                </div>
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="lbNumDocumento" runat="server" Text="Campo Adicional Documento:*" Width="180px" />
                                    </b>
                                    <asp:TextBox runat="server" ID="txtTipoDocumento" CssClass="input-xlarge" Width="360px" />                                                                    
                                    <asp:RequiredFieldValidator ID="RQ_TipoDocumento" runat="server" ValidationGroup="Errores" CssClass="help-block" ControlToValidate="txtTipoDocumento" ErrorMessage=" * El campo 'Campo Adicional' es obligatorio." Width="400px" />  
                                </div>
                                <div>
                                    <b class="control-label">
