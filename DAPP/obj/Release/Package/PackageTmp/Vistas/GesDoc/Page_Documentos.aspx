...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="DivFormulario">
      ...
      ,isnull(ubicaciones.archivo,'') as archivo
	  ,AdminTipoDocumento.nombre as tipodoc
	  ,isnull(Areas.nombre,'Pendiente') Area
      ,isnull(Areas.color,'') Areaid
	  ,isnull(Terceros.nombre,'Pendiente') Tercero
      ,Documentos.fgestion
      ,Documentos.fcentral
      ,Documentos.fhistorico
  FROM Documentos
  ...
  where (Documentos.id_ubicacion is null or Areas.nombre is null or Terceros.nombre is null) and Documentos.id_sucursal=@sucursal">
                        <SelectParameters>
