<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteSticker.aspx.vb" Inherits="DAPP.ReporteSticker" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <rsweb:ReportViewer id="VisorReporte"  runat="server" Width="800px" ShowFindControls="False"  ShowBackButton="False" SizeToReportContent="True" BackColor="#BBD2FD" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="Vistas\Correspondencia\Sticker.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>        
    </form>
</body>
