...
Public Class Page_TipoTerceros
    ...
    Protected Sub bttNuevo_Click(sender As Object, e As ImageClickEventArgs) Handles bttNuevo.Click
        Response.Redirect("../Admin/EditarTipo.aspx?id_tipo=-1")
    End Sub
    ...
    Protected Sub bttEditar_Click(sender As Object, e As ImageClickEventArgs) Handles bttEditar.Click
        If GridTipos.Behaviors.Selection IsNot Nothing AndAlso GridTipos.Behaviors.Selection.SelectedRows.Count > 0 Then
            ...
            If Not rw Is Nothing Then
                ...
                Response.Redirect("../Admin/EditarTipo.aspx?id_tipo=" & id_tp)
            End If
        Else
            Utilidades.Mensaje("No selecciono ningun Tipo de Tercero", Me)
        End If
    End Sub
        ...
        If GridTipos.Behaviors.Selection IsNot Nothing AndAlso GridTipos.Behaviors.Selection.SelectedRows.Count > 0 Then
            ...
            If Not rw Is Nothing Then
                ...
                x = (From td In db.Terceros
                     Where td.id_tipo = id_tp
                     Select td).Count
                If x = 0 Then
                    Dim tipo_eliminar = (From tp In db.AdminTipoTercero
                                         Where tp.Id = id_tp
                    ...
                    If tipo_eliminar IsNot Nothing Then
                        ...
                        Else
                            ids = 0
                        End If
                        Utilidades.RegistrarAuditoria("Tipo Terceros", id_tp, tipo_eliminar.Tipo, "Eliminación Registro", User.Identity.Name, ids)
                        db.AdminTipoTercero.Remove(tipo_eliminar)
                        db.SaveChanges()
                    ...
                    End If
                Else
                    Utilidades.Mensaje("Tiene terceros asociados a este Tipo por favor revisar.", Me)
                End If
    ...
    Protected Sub bttExcel_Click(sender As Object, e As ImageClickEventArgs) Handles bttExcel.Click
        ...
        ExpGrid.DownloadName = "TiposT" & Today.Date.ToString
    ...
    Protected Sub bttPdf_Click(sender As Object, e As ImageClickEventArgs) Handles bttPdf.Click
        ...
        Exppdf.DownloadName = "TiposT" & Today.Date.ToString
