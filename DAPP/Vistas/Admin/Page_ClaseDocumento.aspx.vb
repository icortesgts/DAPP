...
Public Class Page_ClaseDocumento
    ...
    Protected Sub bttNuevo_Click(sender As Object, e As ImageClickEventArgs) Handles bttNuevo.Click
        Response.Redirect("../Admin/EditarClaseDoc.aspx?id_clasedoc=-1")
    End Sub
    ...
    Protected Sub bttEditar_Click(sender As Object, e As ImageClickEventArgs) Handles bttEditar.Click
        If GridTipos.Behaviors.Selection IsNot Nothing AndAlso GridTipos.Behaviors.Selection.SelectedRows.Count > 0 Then
            ...
            If Not rw Is Nothing Then
                ...
                Response.Redirect("../Admin/EditarClaseDoc.aspx?id_clasedoc=" & id_tp)
            End If
        Else
            Utilidades.Mensaje("No selecciono ninguna Clase de Documento", Me)
        End If
    End Sub
    ...
    Protected Sub bttEliminar_Click(sender As Object, e As ImageClickEventArgs) Handles bttEliminar.Click
        If GridTipos.Behaviors.Selection IsNot Nothing AndAlso GridTipos.Behaviors.Selection.SelectedRows.Count > 0 Then
            ...
            If Not rw Is Nothing Then
                ...
                Dim db As New DAPP_BDEntities
                Dim x As Integer
                x = (From td In db.AdminTipoDocumento
                     Where td.id_clase = id_tp
                     Select td).Count
                If x = 0 Then
                    Dim tipo_eliminar = (From tp In db.AdminClaseDocumento
                                         Where tp.id = id_tp
                    ...
                    If tipo_eliminar IsNot Nothing Then
                        ...
                        Else
                            ids = 0
                        End If
                        Utilidades.RegistrarAuditoria("Clase Documentos", id_tp, tipo_eliminar.ClaseDoc, "Eliminación Registro", User.Identity.Name, ids)
                        db.AdminClaseDocumento.Remove(tipo_eliminar)
                        db.SaveChanges()
                    ...
                    End If
                Else
                    Utilidades.Mensaje("Tiene tipos de documento asociados aestaClase de Documento por favor revisar.", Me)
                End If
    ...
    Protected Sub bttExcel_Click(sender As Object, e As ImageClickEventArgs) Handles bttExcel.Click
        ...
        ExpGrid.DownloadName = "ClaseDoc" & Today.Date.ToString
    ...
    Protected Sub bttPdf_Click(sender As Object, e As ImageClickEventArgs) Handles bttPdf.Click
        ...
        Exppdf.DownloadName = "ClaseDoc" & Today.Date.ToString
