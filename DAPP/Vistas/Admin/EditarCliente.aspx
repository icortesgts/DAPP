<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditarCliente.aspx.vb" Inherits="DAPP.EditarCliente" %>
            ...
            <div class="col-sm-12 noPadding colHeight">
                <h3>CLIENTE</h3>               
                    <div class="form-horizontal fom-border">                        
                                ...
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="Label3" runat="server" Text="Prefijo:" Width="180px" />
                                    </b>
                                    <asp:TextBox runat="server" ID="Txtprefijo" CssClass="input-xlarge" Width="180px" />                                    
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Errores" CssClass="help-block" ControlToValidate="txtprefijo" ErrorMessage=" * El campo 'Prefijo' es obligatorio." Width="400px" />
                                </div>
                                <div>
                                    <b class="control-label">
                                ...
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="Label1" runat="server" Text="Logo:" Width="180px" />                                    
                                    </b>
                                    <asp:Image ID="imglogo" runat="server" Width="75" Height="75"  />
                                    
                                    <asp:FileUpload ID="fllogo" runat="server" CssClass="input-xlarge" Width="320px" accept="gif|jpg|png|bmp"/>  
                                </div>
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="Label2" runat="server" Text="Imagen Inicio:" Width="180px" />
                                    </b>
                                    <asp:Image ID="imginicio" runat="server" Width="800" Height="600"  />
                                    <asp:FileUpload ID="flinicio" runat="server" CssClass="input-xlarge" Width="320px" accept="gif|jpg|png|bmp"/>  
                                </div>
