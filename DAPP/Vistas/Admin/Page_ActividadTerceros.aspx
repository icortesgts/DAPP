<%@ Page Title="Actividades Terceros" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_ActividadTerceros.aspx.vb" Inherits="DAPP.Page_ActividadTerceros" %>
...
<%@ Register Assembly="Infragistics45.Web.v15.2, Version=15.2.20152.2273, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" namespace="Infragistics.Web.UI.DataSourceControls" tagprefix="ig" %>


<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <link rel="stylesheet" type="text/css" href="../../Styles/Grids.css">    
    <div class="titular-into-form">
        <span class="texto-titulo-form">ADMINISTRACION DE ACTIVIDADES DE TERCEROS</span>
    ...
    <div class="DivFormulario">
      ...
      ,[Descripcion]
      ,[Activo]
  FROM [DAPPBD].[dbo].[AdminActividad]
