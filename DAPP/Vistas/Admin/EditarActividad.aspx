<%@ Page Title="Edición Actividades" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditarActividad.aspx.vb" Inherits="DAPP.EditarActividad" %>
                    ...
                    <div class="form-horizontal fom-border">                        
                                ...
                                <div>
                                    <b class="control-label">
                                        <asp:Label ID="lbNumDocumento" runat="server" Text="Actividad:*" Width="180px" />
                                    </b>
                                    <asp:TextBox runat="server" ID="txtTipoDocumento" CssClass="input-xlarge" Width="360px" />                                                                    
                                    <asp:RequiredFieldValidator ID="RQ_TipoDocumento" runat="server" ValidationGroup="Errores" CssClass="help-block" ControlToValidate="txtTipoDocumento" ErrorMessage=" * El campo 'Actividad' es obligatorio." Width="400px" />  
                                </div>
                                <div>
                                    <b class="control-label">
