<%@ Page Title="Tipos de Documento" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_TiposDocumento.aspx.vb" Inherits="DAPP.Page_TiposDocumento" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="titular-into-form">
        <span class="texto-titulo-form">ADMINISTRACION DE TIPOS DE DOCUMENTO</span>
        ...
        <table style="margin: auto; width: 100%;">
            ...
            <tr>
                <td style="text-align: center;" colspan="8">
                    ...
                    <asp:SqlDataSource ID="Src_Tipos" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT AdminTipoDocumento.nombre, AdminTipoDocumento.descripcion, AdminTipoDocumento.id,AdminClaseDocumento.ClaseDoc, AdminTipoDocumento.Activo  FROM AdminTipoDocumento 
inner join AdminClaseDocumento 
on AdminTipoDocumento.id_clase=AdminClaseDocumento.id
WHERE AdminTipoDocumento.id_sucursal = @sucursal ORDER BY nombre">
                        <SelectParameters>
