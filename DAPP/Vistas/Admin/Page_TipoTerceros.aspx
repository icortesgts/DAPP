<%@ Page Title="Tipo Terceros" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_TipoTerceros.aspx.vb" Inherits="DAPP.Page_TipoTerceros" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="titular-into-form">
        <span class="texto-titulo-form">ADMINISTRACION DE TIPOS DE TERCEROS</span>
    ...
    <div class="DivFormulario">
                ...
                <td style="text-align: center;" colspan="8">
                    <ig:WebDataGrid ID="GridTipos" runat="server" Width="100%" AutoGenerateColumns="False" CellSpacing="2" HeaderCaptionCssClass="HeaderCaptionClass" StyleSetName="Office2007Blue" EnableDataViewState="True" DataSourceID="Src_Tipos" DataKeyFields="id">
                        <Columns>
                            ...
                            <ig:BoundDataField DataFieldName="listas" Key="listas">
                                <Header Text="Listas de Chequeo">
                                </Header>
                            </ig:BoundDataField>
      ...
      ,[Tipo]
      ,[Descripcion]
      ,(select count(*) from listas_tipo where id_tipo=[AdminTipoTercero].[id]) as listas
      ,[Activo]
  FROM [DAPPBD].[dbo].[AdminTipoTercero]
