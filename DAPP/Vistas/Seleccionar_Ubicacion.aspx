<%@ Page Title="" Language="VB" AutoEventWireup="true" CodeBehind="Seleccionar_Ubicacion.aspx.vb" Inherits="DAPP.Seleccionar_Ubicacion" %>
                ...
                <div class="container mrgnBotMd" style="width: 100%;">
                    <div class="row noPadding">
                        <div class="col-sm-12 noPadding colHeight">
                            <h3>SELECCIONAR UBICACION</h3>
                            <div class="form-horizontal fom-border">

                                <table style="width: 100%;">
                                    <tr>
                                        <td style="text-align: left">
                                            <ig:WebDataTree ID="UbTree" runat="server" Height="400px" Width="600px" BorderColor="#333333" BorderStyle="Dotted" BorderWidth="1px" SelectionType="Single">                                              
                                            </ig:WebDataTree>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="bttSeleccionar" runat="server" Text="Seleccionar Ubicacion" class="btn btn-primary" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
