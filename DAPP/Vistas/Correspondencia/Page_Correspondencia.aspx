<%@ Page Title="Correspondencia" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_Correspondencia.aspx.vb" Inherits="DAPP.Page_Correspondencia" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="titular-into-form">
        <span class="texto-titulo-form">CORRESPONDENCIA EXTERNA</span>
...
WHERE Correspondencia.id_sucursal = @Sucursal and Correspondencia.tipo_correspondencia in ('Externa Enviada','Externa Recibida') and Correspondencia.id_responsable=iif(@responsable=0,Correspondencia.id_responsable,@responsable)
