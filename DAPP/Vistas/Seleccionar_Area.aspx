<%@ Page Title="" Language="VB" AutoEventWireup="true" CodeBehind="Seleccionar_Area.aspx.vb" Inherits="DAPP.Seleccionar_Area" %>
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="text-align: left">
                                            <ig:WebDataTree ID="DocTree" runat="server" Height="400px" Width="600px" BorderColor="#333333" BorderStyle="Dotted" BorderWidth="1px" SelectionType="Single">                                              
                                            </ig:WebDataTree>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="bttSeleccionar" runat="server" Text="Seleccionar Area" class="btn btn-primary" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
