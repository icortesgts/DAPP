<%@ Page Title="SOLICITUD / PRESTAMO DE DOCUMENTOS" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_Solicitudes.aspx.vb" Inherits="DAPP.Page_Solicitudes" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="titular-into-form">
        <span class="texto-titulo-form">SOLICITUD / PRESTAMO DE DOCUMENTOS</span>
