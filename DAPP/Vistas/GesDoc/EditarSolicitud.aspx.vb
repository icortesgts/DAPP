...
Public Class EditarSolicitud
    ...
    Protected Sub btOk_Click(sender As Object, e As EventArgs) Handles btOk.Click
        ...
        Else
            ...
            End If
            If Hdd_id_solicitante.Value = 0 Then
            ...
            Else
                ...
                Next
                Enviar_Correo()
                Response.Redirect("../GesDoc/Page_Solicitudes.aspx")
                End If
    ...
    Private Sub Enviar_Correo()
        ...
        If trx IsNot Nothing Then
            ...
            If id_solicitud <> -1 Then
                subject = "Actualización Solicitud de Prestamo de Documentos - " & txtSolicitante.Text
            ...
            Else
                subject = "Nueva Solicitud de Prestamo de Documentos - " & txtSolicitante.Text
                bodyPlain = subject & Environment.NewLine & Environment.NewLine &
                    "Estimado Usuario, Hemos registrado una transacción de acuerdo al Asunto de este correo:" & Environment.NewLine &
