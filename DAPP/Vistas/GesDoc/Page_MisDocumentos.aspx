<%@ Page Title="Documentos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Page_MisDocumentos.aspx.vb" Inherits="DAPP.Page_MisDocumentos" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="titular-into-form">
        <span class="texto-titulo-form">MIS DOCUMENTOS </span>
    </div>
    <br />
    <br />
