<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditarSolicitud.aspx.vb" Inherits="DAPP.EditarSolicitud" %>
    ...
    <div class="container mrgnBotMd">
        <div class="row noPadding">
            <div class="col-sm-12 noPadding colHeight">
                <h3>SOLICITUD / PRESTAMO DE DOCUMENTOS</h3>
                ...
                <div class="form-horizontal fom-border">
                    ...
                    <div>
                        ...
                        <asp:ImageButton ID="BttDocumento" runat="server" ImageUrl="~/Images/find.png" ImageAlign="Middle" />
                    ...
                    <div>
                        ...
                        <asp:ImageButton ID="BttUbicacion" runat="server" ImageUrl="~/Images/find.png" ImageAlign="Middle" style="height: 16px" />
                    </div>
                    <div>
                        <b class="control-label">
                        ...
                        <asp:ImageButton ID="BttSolicitante" runat="server" ImageUrl="~/Images/find.png" ImageAlign="Middle" />
                    ...
                    <div>
                        ...
                        <asp:ImageButton ID="BttResponsable" runat="server" ImageUrl="~/Images/find.png" ImageAlign="Middle" Enabled="False" Width="16px" style="height: 16px" />                   
                    </div>
                    <div>
                        <b class="control-label">
                            <asp:Label ID="Label2" runat="server" Text="Duración (Días):*" Width="180px"  />
                        </b>
                        <asp:TextBox runat="server" ID="TxtDuracion" CssClass="input-xlarge" Width="320px" TextMode="Number" >1</asp:TextBox>
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="txtEstado" runat="server" CssClass="input-xlarge" Width="320px" Enabled="False" >
                    ...
                    <div>
                        ...
                        <asp:TextBox runat="server" ID="Txtmotivo" CssClass="input-xlarge" Width="320px" TextMode="MultiLine" Height="63px" ></asp:TextBox>
                    </div>
                    <div>
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="width:50%;">
                                    ...
                                    <asp:TextBox runat="server" ID="txtFPrestamo" CssClass="input-xlarge" readonly="true"  Width="180px" textmode="Date"  /> 
                                </td>
                            </tr>
                            <tr>
                                <td style="width:50%;">
                                    ...
                                    <asp:TextBox runat="server" ID="txtFEdevolucion" CssClass="input-xlarge" Width="180px" textmode="Date" readonly="true" /> 
                                ...
                                <td style="width:50%;">
                                    ...
                                    <asp:TextBox runat="server" ID="txtFdevolucion" CssClass="input-xlarge" Width="180px" textmode="Date" readonly="true" /> 
                                </td>
                            </tr>
                        </table>                                  
                    </div>
                    <div>
                        ...
                        <asp:TextBox runat="server" ID="TxtObservaciones" CssClass="input-xlarge" Width="320px" TextMode="MultiLine" Height="63px" Enabled="False" ></asp:TextBox>
                    </div>
                    <br />
                    <br />
