...
Public Class Page_EstadoListas
    ...
    Private Sub GridDocs_InitializeRow(sender As Object, e As RowEventArgs) Handles GridDocs.InitializeRow
        ...
        For i = 0 To e.Row.Items.Count
            ...
            If e.Row.Items.Item(7).Value > 0 Then
                If e.Row.Items.Item(6).Value > 0 Then
                    e.Row.Items.Item(8).CssClass = "yellowBg"
                Else
                    e.Row.Items.Item(8).CssClass = "redBg"
                End If
            Else
                e.Row.Items.Item(8).CssClass = "greenBg"
            End If
