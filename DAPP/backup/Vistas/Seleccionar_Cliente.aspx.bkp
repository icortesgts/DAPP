<%@ Page Title="" Language="VB" AutoEventWireup="true" CodeBehind="Seleccionar_Cliente.aspx.vb" Inherits="DAPP.Seleccionar_Cliente" %>
                        ...
                        <div class="col-sm-12 noPadding colHeight">
                            ...
                            <div class="form-horizontal fom-border">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td class="altura">
                                            <asp:Label ID="lbFiltro" runat="server" Text="Identificacion / Razon Social" class="control-label"></asp:Label>
                                        </td>
                                        <td class="altura">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:Button ID="bttSeleccionar" runat="server" Text="Seleccionar Cliente" class="btn btn-primary" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <asp:SqlDataSource ID="SRC_Datos" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="BuscarCliente" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
