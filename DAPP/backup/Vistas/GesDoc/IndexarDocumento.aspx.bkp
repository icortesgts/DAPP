            ...
            <div class="col-sm-12 noPadding colHeight">
                ...
                <div class="form-horizontal fom-border">
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="txtTipoDocumento" runat="server" Font-Overline="False" Height="20px" Width="320px" CssClass="newsInputD" DataSourceID="SqlTipoDoc" DataTextField="nombre" DataValueField="id" AutoPostBack="True">
                        </asp:DropDownList>
                    </div>
                    <div>
                        <b class="control-label">
